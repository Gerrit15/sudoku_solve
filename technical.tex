...
\end{tikzpicture}
\end{center}
Consider A and B to be tiles that aren't filled it. If only the top row is considered, the wave
function collapse algorithm would say that both $A$ and $B$ be in both a state of being 1 
